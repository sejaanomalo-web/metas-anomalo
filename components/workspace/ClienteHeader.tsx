...
export default function ClienteHeader({
  ...
  function excluir() {
    ...
    startTransition(async () => {
      ...
      router.push("/dashboard/workspace/clientes")
      router.refresh()
    })
  }
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, padding: "2px 0 8px" }}>
        ...
        {/* Excluir a área do cliente. As tarefas continuam no banco e nos
            outros contextos — some a pasta, não o trabalho. */}
        {confirmandoExcluir ? (
          <>
            <button
              type="button"
          ...
          <button
            ...
            title="Excluir este cliente do Workspace"
            className="no-ds ws-btn-icone"
          >
            <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
