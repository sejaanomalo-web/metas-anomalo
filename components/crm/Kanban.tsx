...
import { moverLeadAction } from "@/lib/crm-kanban-actions"
...
export default function Kanban({
  ...
  return (
    ...
    >
      <div className="flex gap-3 overflow-x-auto" style={{ paddingBottom: 8 }}>
        {etapas.map((etapa) => (
          <Coluna
            key={etapa.id}
            etapa={etapa}
  ...
  return (
    ...
    >
      <div className="flex items-center gap-2">
        <Avatar nome={nomeExibido} cor={cor} size={26} />
