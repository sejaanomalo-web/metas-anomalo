...
function SecaoResumo({
  ...
  function atualizar() {
    ...
    startAtualizacao(() => {
      router.refresh()
      // router.refresh é síncrono no client mas o re-render do server
      // só completa quando os Server Components terminam — useTransition
      // mantém o estado de "atualizando" até o re-render acontecer.
      setTimeout(() => {
        setAtualizado(true)
